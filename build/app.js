...
enyo.path.addPaths({layout: "/home/ryltar/git/android_gutoc/assets/www/enyo/tools/../../lib/layout/", onyx: "/home/ryltar/git/android_gutoc/assets/www/enyo/tools/../../lib/onyx/", onyx: "/home/ryltar/git/android_gutoc/assets/www/enyo/tools/../../lib/onyx/source/", private: "/home/ryltar/git/android_gutoc/assets/www/enyo/tools/../../lib/private/", scripts: "../source/scripts/", styles: "../source/styles/"});
...
rendered: function() {
this.inherited(arguments), this.labelChanged(), this.sublabelChanged(), this.choicesChanged(), this.valueChanged(), this.disabledChanged(), this.labelWidthChanged(), this.maxHeightChanged(), this.reflow();
},
reflow: function() {
...
caption: "Black",
className: "custom-background black legend",
name: "black"
}, {
caption: "Blue",
className: "custom-background blue legend",
name: "blue"
}, {
caption: "Green",
className: "custom-background green legend",
name: "green"
}, {
caption: "Orange",
className: "custom-background orange legend",
name: "orange"
}, {
caption: "Pink",
className: "custom-background pink legend",
name: "pink"
}, {
caption: "Purple",
className: "custom-background purple legend",
name: "purple"
}, {
caption: "Red",
className: "custom-background red legend",
name: "red"
}, {
caption: "Teal",
className: "custom-background teal legend",
name: "teal"
}, {
caption: "Yellow",
className: "custom-background yellow legend",
name: "yellow"
...
return this.createComponent(n), this.$[n.name].render(), this.$.container.hide(), this.$[n.name].show(), this.paneStack.push(n.name), !0;
},
...
}), this.$.entries.renderAccountList(), this.inherited(arguments);
},
...
this.$.editAccountCategories.getDisabled() || (this.$.editAccountCategories.setDisabled(!0), this.createComponent({
...
enyo.Signals.send("accountChanged"), this.$.accountCategoryView.hide(), this.$.accountCategoryView.destroy(), this.$.editAccountCategories.setDisabled(!1);
},
modifyTransactionCategories: function() {
this.$.editTransactionCategories.getDisabled() || (this.$.editTransactionCategories.setDisabled(!0), this.createComponent({
...
this.$.transactionCategoryView.hide(), this.$.transactionCategoryView.destroy(), this.$.editTransactionCategories.setDisabled(!1);
},
modifyAutoCompleteSettings: function() {
return;
},
modifyTransactionCategoriesComplete: function() {
this.$.autoCompleteSettingsView.hide(), this.$.autoCompleteSettingsView.destroy(), this.$.editAutoCompleteSettings.setDisabled(!1);
},
fullwipe: function() {
this.createComponent({
...
this.$.instructionsButton.setDisabled(!1), this.$.instructions.show(), this.$.sheetList.hide(), this.doFinish({
success: e
});
}
});
...
this.log(), this.accounts = [], Checkbook.globals.accountManager.fetchAccounts({
onSuccess: enyo.bind(this, this.dataResponse)
});
},
dataResponse: function(e) {
this.log(), this.accounts = enyo.clone(e), this.punt(), enyo.asyncMethod(this.$.loadingScrim, this.$.loadingScrim.hide), enyo.asyncMethod(this.$.loadingSpinner, this.$.loadingSpinner.hide);
},
punt: function() {
this.log(), this.refresh();
},
refresh: function() {
...
onSuccess: function() {
this.log(), enyo.Signals.send("accountChanged", {
...
if (t != n && t > -1 && t < this.accounts.length) {
var r = this.accounts.splice(n, 1), i = this.accounts.slice(t);
this.accounts.length = t, this.accounts.push.apply(this.accounts, r), this.accounts.push.apply(this.accounts, i);
var s = [];
for (var o = 0; o < this.accounts.length; o++) s.push(Checkbook.globals.gts_db.getUpdate("accounts", {
sect_order: o
}, {
rowid: this.accounts[o].acctId
}));
Checkbook.globals.prefs.custom_sort !== 1 && (Checkbook.globals.prefs.custom_sort = 1, s.push(new GTS.databaseQuery({
sql: "UPDATE prefs SET custom_sort = ?;",
values: [ Checkbook.globals.prefs.custom_sort ]
}))), Checkbook.globals.gts_db.queries(s), this.refresh();
}
},
...
setupRow: function(e, t) {
var n = t.index, r = t.item, i = this.accounts[n];
if (i) {
i.index = n, r.$.accountItem.addRemoveClass("alt-row", i.index % 2 === 0), r.$.accountItem.addRemoveClass("norm-row", i.index % 2 !== 0), r.$.accountItem.addRemoveClass("hiddenAccount", i.hidden === 2), r.$.accountItem.addRemoveClass("maskedAccount", i.hidden === 1), r.$.icon.setSrc("assets/" + i.acctCategoryIcon), r.$.iconLock.addRemoveClass("unlocked", i.acctLocked !== 1), r.$.name.setContent(i.acctName);
var s = this.balanceView === 4 ? i.bal_view : this.balanceView;
switch (s) {
case 0:
i.balance = i.balance0;
break;
case 1:
i.balance = i.balance1;
break;
case 2:
i.balance = i.balance2;
break;
case 3:
i.balance = i.balance3;
break;
default:
i.balance = 0;
}
...
var n = t.selected.menuParent.toLowerCase();
if (n === "searchmenu") {
var r = t.content.toLowerCase();
return r === "search" ? this.log("launch search system (overlay like modify account)") : r === "budget" ? this.log("launch budget system (overlay like modify account)") : r === "reports" && this.log("launch report system (overlay like modify account)"), !0;
}
if (n === "accountsortoptions") {
if (Checkbook.globals.prefs.custom_sort === t.selected.value) return;
return Checkbook.globals.prefs.custom_sort = t.selected.value, Checkbook.globals.gts_db.query(new GTS.databaseQuery({
sql: "UPDATE prefs SET custom_sort = ?;",
values: [ Checkbook.globals.prefs.custom_sort ]
}), {
onSuccess: function() {
Checkbook.globals.accountManager.updateAccountModTime(), enyo.Signals.send("accountChanged");
}
}), !0;
}
},
...
rendered: function() {
this.inherited(arguments), this.categories = [];
},
setupRow: function(e, t) {
var n = this.categories[t];
if (n) return this.$.icon.setSrc("assets/" + n.icon), this.$.name.setContent(n.name), this.$.item.setClassName("enyo-item enyo-swipeableitem custom-background legend " + n.color + " enyo-vflexbox"), !0;
},
acquirePage: function(e, t) {
var n = t * e.pageSize;
if (n < 0) return;
this.categories[n] || this.$.manager.fetchCategories({
onSuccess: enyo.bind(this, this.dataResponse, n)
}, e.pageSize, n);
},
dataResponse: function(e, t) {
for (var n = 0; n < t.length; n++) this.categories[e + n] = enyo.clone(t[n]);
this.$.entries.refresh();
},
createNew: function(e, t) {
this.$.modifyCat.openAtCenter(-1);
},
editItem: function(e, t, n) {
var r = this.categories[n];
r && this.$.modifyCat.openAtCenter(r.rowid, r.name, r.icon, r.color);
},
deleteItem: function(e, t) {
var n = this.categories[t];
n && this.$.manager.deleteCategory(n.rowid, n.name, {
onSuccess: enyo.bind(this, this.modificationComplete, "delete")
});
},
modificationComplete: function(e, t) {
enyo.isString(e) && (t = e), enyo.isString(t) && (t === "reorder" ? this.$.entries.refresh() : (this.$.modifyCat.close(), this.categories = [], this.$.entries.punt()));
},
reorder: function(e, t, n) {
...
onSuccess: enyo.bind(this, this.modificationComplete, "reorder")
});
}
}
});
...
openAtCenter: function(e, t, n, r) {
this.inherited(arguments), this.$.name.forceFocus(), this.loadModifySystem(e, t, n, r);
},
loadModifySystem: function(e, t, n, r) {
e < 0 ? (this.$.title.setContent("Create a Category"), this.rowid = -1, this.name = "", this.icon = "", this.color = "") : e > 0 ? (this.$.title.setContent("Edit Category"), this.rowid = e, this.name = t, this.icon = n, this.color = r) : this.close(), this.$.name.setValue(this.name), this.$.icon.setValue(this.icon), this.$.color.setContent(this.color.ucfirst());
for (var i = 0; i < appColors.length; i++) this.$.colorHolder.removeClass(appColors[i].name);
this.$.colorHolder.addClass(this.color), Checkbook.globals.prefs.dispColor === 1 ? this.$.colorHolder.show() : this.$.colorHolder.hide();
},
showColorPicker: function(e) {
this.$.colorPicker.openAtControl(e);
},
menuItemClick: function(e, t) {
this.$.colorHolder.removeClass(this.color), this.color = e.name, this.$.colorHolder.addClass(this.color), this.$.color.setContent(this.color.ucfirst());
},
save: function() {
var e = this.$.name.getValue();
this.icon = this.$.icon.getValue();
if (e.length <= 0) {
this.$.errorMessage.setContent("Category name may not be blank."), this.$.errorMessageContainer.show();
return;
}
...
if (t > 0) {
this.$.errorMessage.setContent("Category names must be unique."), this.$.errorMessageContainer.show();
return;
}
this.$.errorMessageContainer.hide(), this.rowid < 0 ? this.$.manager.createCategory({
name: e,
icon: this.icon,
color: this.color
}, {
onSuccess: enyo.bind(this, this.doChange, "new")
}) : this.$.manager.editCategory(this.rowid, e, this.icon, this.color, this.name, {
onSuccess: enyo.bind(this, this.doChange, "edit")
});
}
});
...
if (!this.account.acctId || this.account.acctId < 0) return this.log("System not ready yet"), !1;
if (n < 0) return !1;
if (this.account.itemCount > this.$.list.getCount() && !this.transactions[n]) return Checkbook.globals.transactionManager.fetchTransactions(this.account, {
...
this.trsnObj.desc = this.$.desc.getValue(), t.data && (this.trsnObj.linkedAccount = this.transactionType === "transfer" ? t.linkedAccount : -1, this.$.linkedAccount.setValue(this.trsnObj.linkedAccount), this.trsnObj.category = t.category, this.categoryChanged()), this.$.amount.focus();
},
...
if (n && r) return r.$.categoryText.setContent((n.category + " >> " + n.category2).dirtyString()), this.trsnObj.category.length > 1 ? (n.amount = Math.abs(n.amount).toFixed(2), this.accountObj["atmEntry"] == 1 ? (r.$.categoryAmount.setValue(deformatAmount(n.amount)), r.$.categoryAmount.setAtm(!0), r.$.categoryAmount.setSelectAllOnFocus(!1)) : (r.$.categoryAmount.setAtm(!1), r.$.categoryAmount.setSelectAllOnFocus(!0)), r.$.categoryAmount.setDisabled(!1), r.$.categoryDelete.setDisabled(!1)) : (r.$.categoryAmount.setDisabled(!0), r.$.categoryDelete.setDisabled(!0), n.amount = 0), !0;
},
...
setupRow: function(e, t) {
var n = this.categories[t];
if (n) return this.$.specific.setContent(n.specCat), t <= 0 || n.genCat !== this.categories[t - 1].genCat ? (this.$.general.show(), this.$.general.setCaption(n.genCat), this.$.general.parent.addClass("categoryRow")) : (this.$.general.hide(), this.$.general.parent.removeClass("categoryRow")), !0;
},
acquirePage: function(e, t) {
var n = t * e.pageSize;
if (n < 0) return;
this.categories[n] || Checkbook.globals.transactionCategoryManager.fetchCategories({
onSuccess: enyo.bind(this, this.dataResponse, n)
}, e.pageSize, n);
},
dataResponse: function(e, t) {
...
dividerTapped: function(e, t) {
t.stopPropagation(), this.$.modifyCat.openAtCenter(-1, e.caption, null);
},
editItem: function(e, t, n) {
var r = this.categories[n];
r && this.$.modifyCat.openAtCenter(r.catId, r.genCat, r.specCat);
},
deleteItem: function(e, t) {
var n = this.categories[t];
n && Checkbook.globals.transactionCategoryManager.deleteCategory(n.catId, {
onSuccess: enyo.bind(this, this.modificationComplete, "delete")
});
},
modificationComplete: function(e, t) {
enyo.isString(e) && (t = e), enyo.isString(t) && (this.$.modifyCat.close(), this.categories = [], this.$.entries.punt());
}
});
...
openAtCenter: function(e, t, n) {
this.inherited(arguments), this.$.general.forceFocus(), this.loadModifySystem(e, t, n);
},
loadModifySystem: function(e, t, n) {
e < 0 && !enyo.isString(t) ? (this.$.title.setContent("Create a Category"), this.$.specific.show(), this.mode = "new", this.id = -1, this.general = "", this.specific = "") : e < 0 && enyo.isString(t) ? (this.$.title.setContent("Edit Group Name"), this.$.specific.hide(), this.mode = "group", this.id = -1, this.general = t, this.specific = "") : e > 0 && enyo.isString(t) && enyo.isString(n) ? (this.$.title.setContent("Edit Category"), this.$.specific.show(), this.mode = "category", this.id = e, this.general = t, this.specific = n) : this.close(), this.$.general.setValue(this.general), this.$.specific.setValue(this.specific);
},
...
this.$.errorMessage.setContent("Category fields may not be blank."), this.$.errorMessageContainer.show();
return;
}
if (t === "All Sub Categories") {
this.$.errorMessage.setContent("Invalid category."), this.$.errorMessageContainer.show();
return;
}
this.$.errorMessageContainer.hide(), this.general === e && this.specific === t && this.close(), this.mode === "new" ? Checkbook.globals.transactionCategoryManager.createCategory(e, t, {
onSuccess: enyo.bind(this, this.doChange, "new")
}) : this.mode === "category" ? Checkbook.globals.transactionCategoryManager.editCategory(this.id, e, t, this.general, this.specific, {
onSuccess: enyo.bind(this, this.doChange, "category")
}) : this.mode === "group" ? Checkbook.globals.transactionCategoryManager.editGroup(e, this.general, {
onSuccess: enyo.bind(this, this.doChange, "group")
}) : this.close();
}
});
...
kind: enyo.Popup,
lazy: !1,
style: "max-width: 350px; height: 350px; border-width: 8px;",
published: {
searchValue: "",
limit: 50
},
...
this.getOwner().$.general && (this.suggestResults = t, this.$.suggestionList.punt(), this.openAtControl(this.getOwner().$.general, {
top: this.getOwner().$.general.getBounds().height,
left: 25
}));
},
setupRow: function(e, t) {
var n = this.suggestResults[t];
if (n) return this.$.general.setContent(n.genCat), !0;
},
rowClicked: function(e, t, n) {
this.doSelect(this.suggestResults[n].genCat), this.searchValue = "", this.close();
}
});
...
this.log(), this.$.icon.setShowing(this.enabled);
},
input: function(e, t) {
...
buildSuggestionList: function(e, t) {
if (this.searchValue !== e) return;
this.values = t, this.valuesChanged();
},
...
var e = [];
for (var t = 0; t < this.values.length; t++) e.push({
content: this.values[t].desc,
index: t,
allowHtml: !0
});
this.$.options.createComponents(e), this.$.options.render(), this.waterfall("onRequestShowMenu", {
activator: this
});
},
itemSelected: function(e, t) {
t.content && t.content.length > 0 && (t.content = t.content.dirtyString(), this.inputField.setValue(t.content)), Checkbook.globals.gts_db.query(new GTS.databaseQuery({
...
values: [ this.getOwner().$.account.getValue(), this.values[t.selected.index].desc ]
}), {
onSuccess: enyo.bind(this, this.dataHandler, t.content)
});
},
...
this.doValueSelected(n), this.searchValue = "";
},
updatePosition: function() {
var e = this.getOwner().$.descWrapper;
if (e.getBounds()) {
var t = this.calcViewportSize(), n = e.getBounds();
this.applyStyle("left", n.left + "px"), this.applyStyle("width", n.width + "px");
var r = 0;
if (e.hasNode()) {
var i = e.hasNode();
do r += i.offsetTop; while (i = i.offsetParent);
} else r = n.top;
this.applyStyle("top", r + n.height + "px");
}
}
});
