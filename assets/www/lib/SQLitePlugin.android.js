( function() {
	...
	SQLitePlugin = function( openargs, openSuccess, openError ) {
		...
		this.openSuccess || ( this.openSuccess = function() {
			...
			return enyo.log( "DB opened: " + dbname );
		});
	...
	SQLitePlugin.prototype.open = function( success, error ) {
		...
		enyo.log( "SQLitePlugin.prototype.open" );
	...
	SQLitePlugin.prototype.close = function( success, error ) {
		...
		enyo.log( "SQLitePlugin.prototype.close" );
	...
	SQLitePlugin.prototype.executePragmaStatement = function( statement, success, error ) {
		...
		enyo.log( "SQLitePlugin::executePragmaStatement" );
		pcb = success;
	...
	SQLitePluginTransaction = function( dbname ) {
		...
		enyo.log( "SQLitePluginTransaction - this.trans_id:" + this.trans_id );
	...
	SQLitePluginTransactionCB.txCompleteCallback = function( transId ) {
		...
		if( typeof transId !== "undefined" ) {
			...
			return enyo.log( "SQLitePluginTransaction.txCompleteCallback---transId = NULL" );
		}
	};
	...
	SQLitePluginTransactionCB.txErrorCallback = function( transId, error ) {
		...
		if( typeof transId !== "undefined" ) {
			...
			enyo.log( "SQLitePluginTransaction.txErrorCallback---transId:" + transId );
			...
			return enyo.log( "SQLitePluginTransaction.txErrorCallback---transId = NULL" );
		}
	};
	...
	SQLitePluginTransaction.prototype.executeSql = function( sql, values, success, error ) {
		...
		if( error ) {
			...
			enyo.log( "error NULL: " + sql );
		}

		enyo.log( "executeSql - add_to_transaction: " + sql );
