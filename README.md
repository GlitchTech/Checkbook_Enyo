...
Checkbook, une application de gestion financière, vous permet de suivre efficacement vos finances sur votre périphérique. Checkbook vous permet de créer jusqu'à 100 comptes différents, et chaque compte peut contenir des milliers de transactions. Compte rendu des revenus, des dépenses et les virements entre comptes en toute simplicité, et de sauvegarder vos données avec Google Spreadsheets. Checkbook est actuellement en développement, avec les nouvelles fonctionnalités ajoutées souvent.
